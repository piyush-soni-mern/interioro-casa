...
class ProductPage extends StatelessWidget {
  const ProductPage({ Key? key, required this.title, required this.titledesc, required this.productcardslist }) : super(key: key);

  final String title ;
  final String titledesc ;
  final List<Product> productcardslist ;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ProductBuilder(productcards: productcardslist,),
                      ],
                    ),
                  ),
                );
